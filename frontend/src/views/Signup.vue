          ...
          <v-card-text>
            <div id="consent_form">
              ...
              <p style="text-align:left">
                This research is being conducted by Jordan Boyd-Graber at the University
                of Maryland, College Park. We are inviting you to participate in this
                research project because you are interested in trivia, quizbowl,
                Jeopardy, and/or general knowledge. The purpose of this research project
                is to make it easier and more efficient to study new facts that may come
              ...
              <p style="text-align:left">
                ...
                website or mobile app with a name, email, and password. You will then be
                asked to select what decks of facts (Jeopardy, history, literature) you
                would like to learn with. An initial evaluation set of 100 facts
                ...
                study facts for as long as you would like each day until the experiment.
                While it is preferred for you to study every day, that is not
                necessarily either. We estimate that you will spend somewhere between 10
                to 60 hours over the course of this study, which will continue to the
                end of December.
              </p>
              ...
              <h3>Compensation</h3>
              <p style="text-align:left">
                $20 will be given to the five users who spend the most time studying in
                the app over the course of the study, which will last until the end of
                December. There will be a 10 x $10 raffle for all other users who were
                active for 80% of the days over the course of the study. If you will
                earn $100 or more as a research participant in this study, you must
                provide your name, address and SSN to receive compensation. If you do
                not earn over $100 only your name and address will be collected to
