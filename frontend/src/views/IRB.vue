  ...
  <v-main>
    <v-card class="elevation-24">
      <v-toolbar dark color="primary">
        <v-toolbar-title
          >{{ appName }} IRB Form/Privacy Policy (Scroll Down To Accept and Dismiss)
        </v-toolbar-title>
        <v-spacer></v-spacer>
      </v-toolbar>
      <v-card-text>
        <div>
          ...
          <p style="text-align:left">
            ...
            project because you are interested in trivia, Quizbowl, Jeopardy,
            Vocabulary, and/or general knowledge. The purpose of this research project
            is to make it easier and more efficient to study new facts that may come up
            in these scenarios.
          </p>
          ...
          <p style="text-align:left">
            Additionally, certain default decks will be specially marked as containing
            flashcards automatically generated from a text generation model. Before
            these decks are shown to users, we will carefully examine and remove cards
            that contain misinformation and potentially offensive language to ensure the
            cards exhibit no additional harm to users. Further, users will have the
            opportunity to submit feedback on each model-generated card and remove the
            ones they no longer wish to see.
          </p>
          <p style="text-align:left">
          ...
          <p style="text-align:left">
            ...
            editing, viewing, submitting feedback) will also be recorded. The only
            identifying information tied to these user ids are the emails and usernames
            of users in this study.
          </p>
          <p style="text-align:left">
            Our study will take place between June 2023 and May 2024. You are encouraged
            (but not required) to study consistently for as long as you would like each
            day. During the course of our study, we estimate that you will spend between
            10 and 500 hours. Continual usage is not required, but we encourage spending
            at least 10 minutes a day for continued practice over time.
          </p>
          <p style="text-align:left">
          ...
          <p style="text-align:left">
            One risk to participants of this study is in confidentiality of study
            participation and data from studying flashcards with the app. This risk will
            be mitigated through the procedures described in Confidentiality. Further,
            using model-generated flashcards poses the risk of generating inaccurate or
            offensive content. We will mitigate this risk by carefully filtering these
            harmful cards before deployment and allowing users to give feedback and
            remove cards they dislike, as described in the Procedures.
          </p>

          <h3>Potential Benefits</h3>
          <p style="text-align:left">
            The benefits to you include the ability to practice trivia and vocabulary
            online, but there are no other direct benefits. However, this study aims to
            use techniques in machine learning and natural language processing to make
            learning and retaining information more efficient. Participants in this
            study may therefore benefit from being able to better study information they
            are interested in online. Practice with this application could also help
            participants prepare for academic competitions, like quizbowl and Jeopardy,
            or exams that rely on vocabulary learning, like the GRE and SAT, through
            exposure to new facts and a potentially improved system for scheduling and
          ...
          <p style="text-align:left">
            ...
            to PI Jordan Boyd-Graber and Co-PIs Shi Feng, Matthew Shu, Nishant Balepur,
            and David Martinez. Your identifiable information (email address) will be
          ...
          <p style="text-align:left">
            The users who study the most flashcards and consistently over the most
            number of days will be entered in a lottery to win [amount TBD] in
            compensation
          </p>
          <p style="text-align:left">
          ...
          <p style="text-align:left">
            ...
            not to take part at all. If you decide to participate in this research, you
            may stop participating at any time. If you decide not to participate in this
            study or if you stop participating at any time, you will not be penalized or
          ...
          <p style="text-align:left">
            ...
            <a src="https://research.umd.edu/irb-research-participants"
              >https://research.umd.edu/irb-research-participants</a
            >
          </p>
          <p style="text-align:left">
