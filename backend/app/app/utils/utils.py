...
def send_test_mode_reminder_email(email_to: str, username: str, rank: str, num_completed_test_mode: str, num_studied: str) -> None:
    ...
    send_email(
        ...
        subject_template=subject,
        html_template=template_str,
        environment={"project_name": settings.PROJECT_NAME, "email": email_to, "username": username, "rank": rank, "num_test_mode_completed": num_completed_test_mode, "num_studied": num_studied},
    )   
